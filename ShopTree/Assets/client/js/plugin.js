...
function(e, t, n) {
    ...
    var g, h, v = e.fn.init, m = e.parseJSON, y = /^[^<]*(.*?)[^>]*$/, b = /^[^<]*<[\w\W]+>[^>]*$/;
    e.fn.init = function(t, n, a) {
        var i;
        return t && "string" == typeof t && !e.isPlainObject(n) && (i = b.exec(t)) && i[0] && ("<" !== t.charAt(0) && r("$(html) HTML strings must start with '<' character"),
        ">" !== t.charAt(t.length - 1) && r("$(html) HTML text after last tag is ignored"),
        "#" === e.trim(t).charAt(0) && (r("HTML string cannot start with a '#' character"),
        e.error("JQMIGRATE: Invalid selector string (XSS)")),
        n && n.context && (n = n.context),
        e.parseHTML) ? (i = y.exec(t),
        v.call(this, e.parseHTML(i[1] || t, n, !0), n, a)) : v.apply(this, arguments)
    }
    ,
    ...
    e.fn.data = function(t) {
        ...
        i = e._data(o, t),
        a !== n && a !== i || i === n) ? j.apply(this, arguments) : (r("Use of jQuery.fn.data('events') is deprecated"),
        i)
    }
    ;
    ...
    e.fn.live = function(t, n, a) {
        ...
        M ? M.apply(this, arguments) : (e(this.context).on(t, this.selector, n, a),
        this)
    }
    ,
    ...
    var i = {
        ...
        lazyLoad: function() {
            ...
            for (e = 0; e < a.itemsAmount; e += 1)
                ...
                s && i < a.currentItem + a.options.items && n.length && a.lazyPreload(o, n)) : o.data("owl-loaded", "loaded"))
        },
