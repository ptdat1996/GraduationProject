    ...
    if (shoppingCart.length === 0) {
        ...
        for (var i in shoppingCart) {
            ...
            cartElement += '<div class="cart_item clearfix">'
                ...
                + '<img src="' + shoppingCart[i].imageUrl.replace('~','') + '"/>'
                + '</div>'
    ...
    if (shoppingCart.length === 0) {
        ...
        for (var i in shoppingCart) {
            ...
            cartElement += '<tr proid="' + shoppingCart[i].productId +'">'
                        ...
                        + '<img class="img-responsive" src="' + shoppingCart[i].imageUrl.replace('~','') + '">'
                        + '</a>'
                        + '</td>'
                        + '<td class="des">'               
    ...
    if (shoppingCart.length === 0) {
        ...
        for (var i in shoppingCart) {
            ...
            cartElement += '<div class="cart-item clearfix">'
                ...
                + '<img src="' + shoppingCart[i].imageUrl.replace('~','') + '" class="img-responsive">'
                + '</a>'
                + '</span>'
